...
const IgIcon = () => (
  <svg viewBox="0 0 24 24" width="44" height="44" aria-hidden="true" style={{ opacity: 1, filter: "none", display: "block" }}>
    ...
    {/* OFFICIAL INSTAGRAM GRADIENT inner disc */}
    <circle cx="12" cy="12" r="8.6" fill="url(#igGrad)" />
    {/* OFFICIAL WHITE INSTAGRAM CAMERA GLYPH (Simple Icons brand path) */}
...
const FbIcon = () => (
  <svg viewBox="0 0 24 24" width="44" height="44" aria-hidden="true" style={{ opacity: 1, filter: "none", display: "block" }}>
    ...
    {/* WHITE lowercase "f" — 18% smaller, centered */}
    <g transform="translate(12.35,11.75) scale(0.82) translate(-12.35,-11.75)">
...
const WaIcon = () => (
  <svg viewBox="0 0 24 24" width="44" height="44" aria-hidden="true" style={{ opacity: 1, filter: "none", display: "block" }}>
    {/* WHITE outer circle */}
    <circle cx="12" cy="12" r="11.5" fill="#FFFFFF" />
    {/* BRIGHT WHATSAPP GREEN inner disc */}
    <circle cx="12" cy="12" r="8.6" fill="#25D366" />
    {/* OFFICIAL WHITE WHATSAPP LOGO (Simple Icons brand path) */}
